...
class Config:
    ...
    # ===========================================
    AVAILABLE_MODELS = ["mobilenetv3_large", "mobilenetv3_large_iti", "cosface_resnet50", "topofr_r50_ms1mv2", "topofr_r100_ms1mv2", "topofr_r200_ms1mv2", "topofr_r50_glint", "topofr_r100_glint", "topofr_r200_glint"]
