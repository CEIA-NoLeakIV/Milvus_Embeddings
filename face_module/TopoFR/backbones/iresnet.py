...
class IResNet(nn.Module):
    ...
    def __init__(self,
        ...
        # Adiciona camada de pesos (weight) para classificação se num_classes for fornecido
    ...
    def forward(self, x):
        ...
        x = torch.flatten(x, 1)  # Achata (1, 512, 7, 7) para (1, 25088)
        x = self.dropout(x)      # Aplica o dropout definido no __init__
        ...
        x = linear(normalize(x), normalize(self.weight))
        return x
